...
area3 = round(area3, 4)
text(x = 7.0, y = 0.037, paste("Area = ", area3, sep = ""))
```
...
text(x = -2.4, y = 0.3, paste("Area = ", area4, sep = ""))
```
...
curve(dgamma(x, shape = 3, scale = 1), xlim = c(0, 10), ylim = c(0, 1), col = "Green2", add = TRUE, lwd = 2)
...
```{r}
curve(dgamma(x, shape = 6, scale = 3), xlim = c(0, 30), ylim = c(0, 0.06), lwd = 2, ylab = "Gamma Density", xlab = "Y", main = "Shape6; Scale = 3")
...
curve(dchisq(x, df = 2), xlim = c(0, 15), ylim = c(0, 0.75), lwd = 2, xlab = "Y", ylab = "Chi-Square Density", col = "Plum1", main = "Degrees of Freedom: 2")
...
```{r}
curve(dchisq(x, df = 2), xlim = c(0, 10), ylim = c(0, 0.75), lwd = 2, xlab = "Y", ylab = "Chi-Square Density", col = "Slate Grey", main = "Degrees of Freedom: 2")
...
text(x = 3.3, y = 0.25, paste("Area = ", cprob1, seq = ""))
```

```{r}
curve(dchisq(x, df = 3), xlim = c(0, 10), ylim = c(0, 0.3), lwd = 2, xlab = "Y", ylab = "Chi-Square Density", col = "Slate Gray", main = "Degrees of Freedom: 3")
...
text(x = 5, y = 0.15, paste("Area = ", cprob2, seq = ""))
```

```{r}
curve(dchisq(x, df = 20), xlim = c(0, 35), ylim = c(0, 0.07), lwd = 2, xlab = "Y", ylab = "Chi-Square Density", col = "Slate Gray", main = "Degrees of Freedom: 20")
...
text(x = 17, y = 0.04, paste("Area = ", cprob3, seq = ""))
```
...
curve(dweibull(x, shape = 10, scale = 3), xlim = c(0, 10), ylim = c(0, 1.5), col = "Pink", lwd = 2, ylab = "Weibull Density", main = "Shape = 10, Scale = 3")
```
...
```{r}
curve(dbeta(x, shape1 = 6, shape2 = 3), xlim = c(0, 1), col = "Gray", lwd = 2, ylab = "Beta Density", xlab = "Y", main = "Shape1 = 6, Shape2 = 3")
...
prob = round(prob, 4)
text(x = 0.25, y = 1, paste("Area2 = ", prob, sep = ""))
```

```{r}
curve(dbeta(x, shape1 = 2, shape2 = 10), xlim = c(0, 1), col = "Black", lwd = 2, ylab = "Beta Density", xlab = "Y", main = "Shape1 = 2, Shape2 = 10")
